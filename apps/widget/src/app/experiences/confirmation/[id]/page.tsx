...
export default async function DirectConfirmationPage({ params }: ConfirmationPageProps) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        <div className="bg-card rounded-card border border-border p-8 text-center">
          ...
          <h1 className="text-3xl text-heading-foreground mb-2">
            Booking Confirmed!
          </h1>
          ...
          <div className="text-left mb-8">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
          ...
          <Link
            href="/experiences"
            className="inline-flex items-center justify-center px-6 py-3.5 bg-accent text-accent-foreground font-medium rounded-button hover:opacity-90 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
